...
export const metadata: Metadata = {
  ...
  description: "Jak usunąć konto egzaminio i dane powiązane z logowaniem Google lub Facebook.",
  robots: { index: false, follow: false },
};

export default function DeleteAccountPage() {
  return (
    <LegalShell currentPath="/usun-konto" title="Usunięcie konta i danych" description="Instrukcja dla kont e-mail, Google i Facebook · 24 sierpnia 2026 r.">
      ...
      <section className="legal-section"><h2>Google i Facebook</h2><p>Odłączenie egzaminio w ustawieniach Google lub Facebooka zatrzymuje przyszły dostęp przez danego providera, ale nie zawsze usuwa konto zapisane w egzaminio. Aby usunąć dane z naszej bazy, wykonaj procedurę powyżej. Nie publikujemy treści w Twoim imieniu.</p></section>
