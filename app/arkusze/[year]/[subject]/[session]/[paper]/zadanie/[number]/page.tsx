    ...
    <main className="knowledge-page cke-solution-page">
      ...
      <article className="mathjax_process">
        ...
        <div className="knowledge-layout">
          ...
          <aside className="knowledge-aside"><Card className="knowledge-cta"><CardHeader><FileCheck2 aria-hidden="true" /><CardTitle>Rozwiąż zadanie samodzielnie</CardTitle></CardHeader><CardContent><p>W aplikacji możesz najpierw podać własną odpowiedź, a dopiero potem zobaczyć wyjaśnienie i zapytać AI o konkretny krok.</p><Button asChild><a href="/logowanie?tryb=rejestracja&rola=uczen">Przejdź do ćwiczeń <ArrowRight aria-hidden="true" /></a></Button></CardContent></Card><nav className="knowledge-related" aria-label="Powiązany temat"><b>Powiązany temat</b><a href={page.subject === "mathematics" ? "/matematyka" : page.subject === "polish" ? "/jezyk-polski" : page.subject === "english" ? "/jezyk-angielski" : "/arkusze"}>{page.related_topic}<ArrowRight aria-hidden="true" /></a></nav></aside>
        </div>
      </article>
      <SeoFooter />
    </main>
