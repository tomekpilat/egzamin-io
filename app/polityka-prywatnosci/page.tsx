  ...
  return (
    <LegalShell currentPath="/polityka-prywatnosci" title="Polityka prywatności" description={`Wersja robocza · ostatnia aktualizacja: ${LEGAL_UPDATED_LABEL}`}>
      ...
      <section className="legal-section" id="dane">
        ...
        <p>Nie prosimy o diagnozę, orzeczenie, dokumentację medyczną, PESEL ani adres domowy ucznia. Nie wpisuj informacji zdrowotnych do rozmowy z AI.</p>
      </section>
      ...
      <section className="legal-section" id="dzieci">
        ...
        <ul>
          <li>Rodzic zobaczy po połączeniu konta i aktywacji Pakietu Plus postęp, regularność, obszary do powtórki oraz liczbę zakończonych pytań do AI w wybranym okresie.</li>
