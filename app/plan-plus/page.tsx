    ...
    <main className="plan-plus-page">
      ...
      <section className="plan-plus-shell">
        ...
        <Card className="pricing-table-card plan-plus-comparison">
          ...
          <div className="pricing-actions">{checkout.enabled ? <Button asChild><a href={checkout.url} data-analytics-event="plan_plus_cta_clicked">Zamawiam i płacę {PLUS_ANNUAL_PRICE_PLN} zł</a></Button> : <Button asChild><a href="#lista-plus" data-analytics-event="plan_plus_cta_clicked">Powiadom mnie o starcie</a></Button>}<Button variant="outline" asChild><a href="/panel">Zostań przy planie Free</a></Button></div>
